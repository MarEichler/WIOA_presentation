/* slidy.js
   ...
   MYE: copied JS file from https://www.w3.org/Talks/Tools/Slidy2/scripts/slidy.js
   MAKE FOLLOWING EDITS: 
     - remove pop-up text about how to navigate slides 
     - remove 'help?' footer links
     - rename 'contents?' footer link to 'Contents'
...
*/
  ...
  add_initial_prompt: function () {
    ...
    //MYE EDIT: remove pop-up when first open slides 
    // if (this.keyboardless)
  ...
  add_toolbar: function () {
    var counter, page;
     ...
     if (this.ns_pos || !this.ie6)
     {
       ...
       contents.innerHTML = this.localize("Contents"); // MYE EDIT: change text from 'contents?' to 'Contents'
